...
const content = {
  ...
  es: {
    ...
    s7p2: "Trabajando en estrecha colaboración con la familia de Sylvia Rexach, sus grabaciones presentan la música de Rexach y Tutti Umpierre con un compromiso de autenticidad histórica, al tiempo que introducen la obra a nuevas audiencias en todo el mundo. Desde 2023, Weibe y Maritzaida han lanzado 8 álbumes.",
