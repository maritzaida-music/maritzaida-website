...
const translations: Record<Lang, Record<string, string>> = {
  ...
  es: {
    ...
    "epk.bio.text": "Maritzaida es una vocalista puertorriqueña dedicada al arte de la música bohemia y el bolero. Junto a su esposo y guitarrista AJ Weibe, su trabajo se centra en preservar y reinterpretar las obras maestras de la compositora Sylvia Rexach y el guitarrista Tutti Umpierre — dos de las figuras musicales más queridas de Puerto Rico. Desde 2023, Maritzaida ha lanzado 8 álbumes y EPs, culminando con el reconocido Alma Adentro (2024), clasificado #16 entre los 20 Álbumes Más Destacados de 2024 por La Fundación Para La Cultura Popular de Puerto Rico. Su álbum de 2025 Radio Bohemia Volumen I cuenta con la participación especial de Sharon Riley Rexach, hija de Sylvia Rexach, y está inspirado en las icónicas transmisiones radiales de 1953 que definieron una era.",
